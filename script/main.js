...
function translateToDutch() {
    ...
    document.getElementById("intro-text").innerHTML = "Mijn naam is Jonas Koens, ik ben een 21 jaar oude software engineering student aan de Fontys Hogeschool. Ik ben een fervent probleemoplosser, dus voor elke complexe programmeertaak wordt ik enthousiast. <br> <br> <a href='/pages/about.html' id='about-page-link'>Meer over mij <img src='/images/scroll-btn.svg' id='rotated-scroll-btn'></a>";
